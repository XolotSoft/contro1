...
class Personal extends Main
{
    ...
    public function Enumerate()
    {
        ...
        $this->Util()->DB()->setQuery('SELECT * FROM personal ORDER BY name ASC');
        $result = $this->Util()->DB()->GetResult();
    ...
    public function Info()
    {
        ...
        $sql = "SELECT * FROM personal WHERE personalId = '".$this->personalId."'";
    ...
    public function Delete(){
        ...
        $sql = "DELETE FROM personal WHERE personalId = ".$this->personalId;
